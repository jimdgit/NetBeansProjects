...
public class Customer  implements java.io.Serializable {
    ...
    public Customer(int customerId, DiscountCode discountCode, MicroMarket microMarket, String name, String addressline1, String addressline2, String city, String state, String phone, String fax, String email, Integer creditLimit, Set<PurchaseOrder> purchaseOrders) {
       this.customerId = customerId;
       this.discountCode = discountCode;
       this.microMarket = microMarket;
       this.name = name;
